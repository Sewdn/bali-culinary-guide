...
const chapters = [
  ...
  },
  {
    ...
    image: "/balinese-street-food-market.png",
    color: "bg-pink-500",
  },
  {
    id: "rice-meals",
  ...
  },
  {
    ...
    image: "/balinese-sate-lilit-grilling.png",
    color: "bg-rose-500",
  },
  {
    id: "bakso",
  ...
  },
  {
    ...
    image: "/indonesian-grilled-fish.png",
    color: "bg-rose-700",
  },
  {
    id: "desserts",
          ...
          {chapters.map((chapter) => (
            ...
            >
              <div className="relative">
                ...
                />
                <div
                  className={`absolute top-4 left-4 ${chapter.color} text-white px-3 py-1 rounded-full text-sm font-medium`}
                >
